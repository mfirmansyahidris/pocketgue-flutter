...
class Dimens {
  ...
  static double appbarSearch = 55.h;

  static double iconS = 15.h;
  static double iconM = 20.h;
  static double iconL = 25.h;
  ...
  static double cornerRadius = 5.w;
  static double cornerRadiusL = 15.w;
  static double cornerRadiusXL = 30.w;
